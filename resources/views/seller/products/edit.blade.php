        ...
        <form method="POST" action="{{ route('seller.products.update', $product) }}">
            ...
            <div>
                ...
                <select id="condition" name="condition" required>
                    ...
                    <option value="baru" @selected(old('condition', $product->condition) === 'baru')>Baru</option>
                    <option value="bekas" @selected(old('condition', $product->condition) === 'bekas')>Bekas</option>
                </select>
            </div>
            <div>
