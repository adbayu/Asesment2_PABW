...
<body>
    <div class="shell">
        <div>
            ...
            <p class="muted">Lengkapi detail produk yang akan dijual.</p>
        </div>
        ...
        <form method="POST" action="{{ route('seller.products.store') }}">
            ...
            <div>
                ...
                <select id="condition" name="condition" required>
                    ...
                    <option value="bekas" @selected(old('condition')==='bekas' )>Bekas</option>
                </select>
            </div>
            <div>
                <label for="description">Deskripsi</label>
                <textarea id="description" name="description"
                    placeholder="Detail produk, spesifikasi, catatan">{{ old('description') }}</textarea>
            </div>
            <div class="actions">
                <a class="btn secondary" href="{{ route('seller.products.index') }}">Batal</a>
